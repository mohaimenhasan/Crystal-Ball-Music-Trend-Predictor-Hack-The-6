...
var returnTest = [{"Acousticness":{"0":0.0529,"1":0.0047,"2":0.61,"3":0.0392,"4":0.0845,"5":0.874,"6":0.281,"7":0.00281,"8":0.000259,"9":0.203,"10":0.000276,"11":0.0512,"12":0.246,"13":0.022,"14":0.0964,"15":0.0377,"16":0.401,"17":0.0508,"18":0.313,"19":0.00257},"Danceability":{"0":0.757,"1":0.637,"2":0.421,"3":0.675,"4":0.755,"5":0.559,"6":0.457,"7":0.446,"8":0.904,"9":0.454,"10":0.607,"11":0.772,"12":0.448,"13":0.545,"14":0.728,"15":0.72,"16":0.763,"17":0.61,"18":0.756,"19":0.62},"PredictedPopularity":{"0":61,"1":75,"2":32,"3":65,"4":52,"5":7,"6":73,"7":90,"8":63,"9":55,"10":42,"11":56,"12":80,"13":68,"14":63,"15":71,"16":45,"17":53,"18":45,"19":56},"Speechiness":{"0":0.0399,"1":0.365,"2":0.173,"3":0.0318,"4":0.0596,"5":0.0659,"6":0.102,"7":0.141,"8":0.0888,"9":0.0718,"10":0.0393,"11":0.108,"12":0.0471,"13":0.0832,"14":0.0318,"15":0.0337,"16":0.1,"17":0.0269,"18":0.0384,"19":0.0581},"Tempo":{"0":125.965,"1":139.931,"2":78.621,"3":134.936,"4":103.026,"5":77.87,"6":144.855,"7":190.013,"8":150.02,"9":141.818,"10":130.933,"11":124.988,"12":164.233,"13":135.006,"14":127.995,"15":107.969,"16":120.06,"17":133.882,"18":109.53,"19":104.324},"id":{"0":"0UfYmrq68ojmGGhBdLMG4M","1":"6HZILIRieu8S0iqY8kIKhj","2":"05u81UgU27g8uL5twJ7ABz","3":"73NbHgUZ51H65Bfo2HFKUi","4":"6Xn9vkq4nvHOWhagf3168L","5":"6lFDB0BFDRV58qaQDX85jV","6":"0ZpBPavoID3eDbaXKSWpAD","7":"1BwhFXqoIsePt21WyWIttb","8":"7KXjTSCq5nL1LoYtL7XAwS","9":"6RI2Vy73ey1ZjFAuBBa6Z8","10":"6af9mKX0z2lFRKnsGssOWA","11":"1NtIMM4N0cFa1dNzN15chl","12":"2ZYBwkmtYhgUj1A7teYAZ7","13":"4AewKenHXKBt643p473xCk","14":"7MUNNBJKYo3cdokp06wEOB","15":"4Piz3X660g9bu8fymDOy9h","16":"5q5gzmbBS5yQzos2BvVr1t","17":"7KubeWC5zOcYOLTYxCtnYE","18":"5li3FHS5s9V3l4xWsUcmQa","19":"7ARveOiD31w2Nq0n5FsSf8"}}]
console.log(returnTest[0].PredictedPopularity)
...
var playing = false
var datas1 = document.getElementsByClassName('data')
var images = document.getElementsByClassName('image')
var icons = document.getElementsByClassName('icons')


function predict(i){
      var predictedPop = returnTest[0].PredictedPopularity 
      var netChange =  -storeItems[i].popularity + returnTest[0].PredictedPopularity[i]
      animateValue('pre'+i, 0, netChange, 2000)
      animateValue('rating'+i, storeItems[i].popularity, returnTest[0].PredictedPopularity[i], 2000)
}
...
spotifyApi.getMyTopTracks({"limit":20, "offset": 20 })
.then(function(data){
  ...
  trackDetails()
    ...
    for (var i = 0; i < images.length; i++){
      ...
      var pop = document.createElement('h2')
      pop.className = "popularity"
      pop.innerHTML = 'Rank:' + '<br>' + (i+1) 
      // + '<br>' + data.items[0].popularity
      images[i].appendChild(pop)

      var title = document.createElement('h1') 
      title.className = 'songTitle'
      title.innerHTML = data.items[i].name 
      datas1[i].appendChild(title)

      var artists = document.createElement('h3')
      artists.className = 'artists'
      artists.innerHTML = data.items[i].artists[0].name
      datas1[i].appendChild(artists)

      var rating = document.createElement('div')
      rating.className = 'rating'
      rating.innerHTML = data.items[i].popularity
      rating.id = 'rating'+i
      ...
      var acoustic = document.createElement('div')
      acoustic.className = 'acoustic'
      icons[i].appendChild(acoustic)

      var acousticDescription = document.createElement('h3')
      acousticDescription.className = 'acousticDescription'
      acousticDescription.innerHTML = 'Acousticness'
      acoustic.appendChild(acousticDescription)


      var danceability = document.createElement('div')
      danceability.className = 'dance'
      icons[i].appendChild(danceability)

      var danceabilityDescription = document.createElement('h3')
      danceabilityDescription.className = 'acousticDescription'
      danceabilityDescription.innerHTML = 'Danceability'
      danceability.appendChild(danceabilityDescription)

      var speechiness = document.createElement('div')
      speechiness.className = 'speech'
      icons[i].appendChild(speechiness)

      var speechinessDescription = document.createElement('h3')
      speechinessDescription.className = 'acousticDescription'
      speechinessDescription.innerHTML = 'Speechiness'
      speechiness.appendChild(speechinessDescription)

      var tempo = document.createElement('div')
      tempo.className = 'tempo'
      icons[i].appendChild(tempo)

      var tempoDescription = document.createElement('h3')
      tempoDescription.className = 'acousticDescription'
      tempoDescription.innerHTML = 'Tempo'
      tempo.appendChild(tempoDescription)
      ...
      // audioObject = new Audio(data.items[i].preview_url);
    }
...
//     console.log(jsonInfo[i])
//     jsonInfo[i].track['popularity'] = favItems[i].track.popularity
//   }
//   console.log(jsonInfo)
// }
...
// spotifyApi.getMyTopTracks({"limit":50, "offset": 20 })
// .then(function(data){
//   for (var i=0; i < data.items.length; i++){
//     favItems = data.items
//     // console.log(data.items[i].name)
...
// spotifyApi.getPlaylistTracks('Spotify', '37i9dQZF1DWSQScAbo5nGF', { 'offset' : 1, 'limit' : 100, 'fields' : 'items' })
//   .then(function(data) {
//     favItems = data.items
...
// function download(){
//   var headers = {
//       acousticness: 'acousticness'.replace(/,/g, ''), // remove commas to avoid errors
...
//   //     }
//   // ];
//   var popularityFormatted =[];
//   var itemsFormatted = [];

//   // format the data
//   favItems.forEach((item) => {
//       popularityFormatted.push({
//           popularity: item.track.popularity, // remove commas to avoid errors,
//       });
//       console.log(popularityFormatted)
//   });
...
//           acousticness: item[0].acousticness, // remove commas to avoid errors,
//           analysis_url: item[0].analysis_url,
//           danceability: item[0].danceability,
//           duration_ms: item[0].duration_ms,
//           energy: item[0].energy,
//           id: item[0].id,
//           instrumentalness: item[0].instrumentalness,
//           key: item[0].key,
//           liveness: item[0].liveness,
//           loudness: item[0].loudness,
//           mode: item[0].mode,
//           speechiness: item[0].speechiness,
//           tempo: item[0].tempo,
//           time_signature: item[0].time_signature,
//           track_href: item[0] .track_href,
//           type: item[0].type,
//           uri: item[0].uri,
//           valence: item[0].valence,
//       });
//   });
...
//   exportCSVFile(headers1, popularityFormatted, fileTitle); // call the exportCSVFile() function to process the JSON and trigger the download
// }